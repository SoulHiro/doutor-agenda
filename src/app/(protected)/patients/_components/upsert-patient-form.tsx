...
import {
  UpsertPatientSchema as UpsertPatientSchemaType,
  upsertPatientSchema as UpsertPatientFormSchema,
...
const UpsertPatientForm = ({
  ...
  const form = useForm<UpsertPatientSchemaType>({
  ...
  const onSubmit = (values: UpsertPatientSchemaType) => {
